...
export const AssistantModal = () => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent side="top" align="end" className="h-[500px] w-[400px] rounded p-0">
        <Thread />
      </PopoverContent>
    </Popover>
  );
...
const FloatingAssistantButton = forwardRef<HTMLButtonElement, FloatingAssistantButton>(
